...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(GreenBookApiException.class)
    public ResponseEntity<ErrorDetails> handleReservationApiExceptions(GreenBookApiException exception , WebRequest request)
    {
